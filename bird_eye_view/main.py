...
class BirdEyeModule:
    def __init__(self, video_path, output_dir, output_vid):
        ...
        self.calculate_social_distancing(video_path, net_yl, output_dir, output_vid, ln1)
    ...
    def calculate_social_distancing(self, vid_path, net, output_dir, output_vid, ln1):
